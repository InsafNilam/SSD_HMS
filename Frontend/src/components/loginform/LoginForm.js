            ...
            <div className='appointment-container'>
                ...
                <form action='#'>
                    ...
                    <div className='input-box'>
                        <label htmlFor='useremail' className='details'>UserEmail</label>
                        <div className='input-group'>
                        <input id='useremail' ref={inputUserEmail} type='text' name='email' placeholder='useremail' value={values.email} onChange={handleChange}/>
                    ...
                    <div className='time-details'>
                        ...
                        <div className='time-group user-group'>
                            <input type='radio' id='admin' name='type' value='admin' onChange={handleChange}/>
                            <input type='radio' id='doctor' name='type' value='doctor' onChange={handleChange}/>
                            <input type='radio' id='patient' name='type' value='patient' defaultChecked onChange={handleChange}/>
                            <input type='radio' id='other' name='type' value='other' onChange={handleChange}/>
                            </div>
                            <div className='time-group'>
